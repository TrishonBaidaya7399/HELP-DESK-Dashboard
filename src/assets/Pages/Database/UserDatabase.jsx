...
const UserDatabase = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const operatorUsers = response.data.filter(user => user.role === "user");
  ...
  return (
    <div className="pt-6 pb-12 mb-auto">
      ...
      <Link className="border-r-2 border-black text-center text-xl text-white bg-[#296EF2]" to="/database/user">
        <button >
          User
        </button>
        </Link>
